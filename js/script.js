...
guessNumber("Alex", num);

/* Mistakes in the original file: 
1) in index.html file js/script.js was misspelled as "js/scripto.js";
2) in script.js file showGuess.innerText is misspelled as "showguess.innerText";
3) in script.js file else if is misspelled as "elseif";
4) in script.js file Octavia (which I replaced with Alex) was missing quotation marks around it, so was undefined.*/
